...
import de.rwthaachen.openlap.analyticsmethods.controller.AnalyticsMethodsUploadController;
...
/**
 * Integration tests for the Analytics Methods macro component
 */
...
public class AnalyticsMethodsApplicationTests {
    ...
    public void controllerViewAnalyticsMethodByIdTest() throws Exception {
        ...
        this.mockMvc.perform(get("/AnalyticsMethods/10"))
                ...
                .andExpect(jsonPath("$.content.exception").exists());
    }
